 ...
 * <p>
 * The exit value returned by the process, if set in the exception, may be retrieved with 'getExitValue()'.  If not set,
 * the returned exit value is -1.
 *
 */
public class TaskExecutionException extends Exception {
   ...
   /**
    * Constructs a TaskExecutionException with the specified error detail message and cause and an invalid exit value of
    * -1.
    * <p>
    * Note that the detail message associated with cause is not automatically incorporated into this exception's detail
    * message.
    *
    * @param message
    *    the detail message
   ...
   /**
    * Constructs a TaskExecutionException with the specified cause and detail message of (cause==null ? null :
    * cause.toString()) (which typically contains the class and detail message of cause) and an invalid exit value of
    * -1.
    *
    * @param cause
    *    the cause (A null value is permitted, and indicates that the cause is nonexistent or unknown.)
   ...
   /**
    * Constructs a TaskExecutionException with the specified cause, detail message of (cause==null ? null :
    * cause.toString()) (which typically contains the class and detail message of cause), and exit value.
    *
    * @param cause
    *    the cause (A null value is permitted, and indicates that the cause is nonexistent or unknown.)
    * @param exitValue
